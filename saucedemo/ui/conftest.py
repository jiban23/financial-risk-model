"""Cross-browser driver setup for the UI / visual suite.

Every UI test that requests the ``driver`` fixture runs once per browser listed
in ``--browsers`` (default: chrome, firefox, edge, opera). Browsers that are not
